export default function ScrolledNavBar() {
    return (
        <div className="fixed top-0 z-20 w-[1891px] h-[61px] bg-blue-900 flex items-center">
            <ul className="w-full flex flex-row justify-between items-center text-[14px] antialiased text-white font-semibold uppercase">
                ...
                <li className="w-1/3 cursor-pointer flex justify-center text-3xl">AE LOGSAVERS</li>
                <li>                
                </li>
